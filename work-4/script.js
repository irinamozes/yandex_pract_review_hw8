...
/* REVIEW. Резюме.
Код  выполняет требуемый по заданиям функционал, но после сабмита формы профиля переходит на другую страницу по ссылке, что не предполагается логикой задания.
